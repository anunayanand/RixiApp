...
const { sendPayoutSuccessMail, sendVoucherEmail } = require("../../services/emails/payoutMailScript");
const { generateSalarySlip } = require("../../services/documents/salarySlipGenerator");
...
exports.renderPayoutCenter = asyncHandler(async (req, res) => {
...
exports.addExpenditure = asyncHandler(async (req, res) => {
...
exports.verifySecret = asyncHandler(async (req, res) => {
...
exports.setSecret = asyncHandler(async (req, res) => {
...
exports.resetSecret = asyncHandler(async (req, res) => {
...
exports.approveAmbassadorPayout = asyncHandler(async (req, res) => {
...
exports.rejectAmbassadorPayout = asyncHandler(async (req, res) => {
  const tx = await PaymentTransaction.findById(req.params.txId);
...
exports.updateAdminPayroll = asyncHandler(async (req, res) => {
...
exports.settleAdminSalary = asyncHandler(async (req, res) => {
  const admin = await Admin.findById(req.params.adminId);
  if (!admin) return res.status(404).json({ success: false, message: "Admin not found" });
...
exports.approveAdminPf = asyncHandler(async (req, res) => {
...
exports.rejectAdminPf = asyncHandler(async (req, res) => {
  const admin = await Admin.findById(req.params.adminId);
  if (!admin) return res.status(404).json({ success: false, message: "Admin not found" });
...
exports.downloadSalarySlip = asyncHandler(async (req, res) => {
  const admin = await Admin.findById(req.params.adminId);
...
exports.approveInternRedemption = asyncHandler(async (req, res) => {
...
exports.rejectInternRedemption = asyncHandler(async (req, res) => {
