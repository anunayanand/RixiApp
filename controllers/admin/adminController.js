...
const { sendConfirmationMail } = require("../../services/emails/confirmationMailScript");
const PaymentTransaction = require("../../models/PaymentTransaction");
const { generateSalarySlip, generatePFSlip } = require("../../services/documents/salarySlipGenerator");
...
exports.acceptRegistration = asyncHandler(async (req, res) => {
  const { id } = req.params;
...
exports.requestPfWithdrawal = asyncHandler(async (req, res) => {
  const adminId = req.session.user;
...
exports.downloadPfSlip = asyncHandler(async (req, res) => {
  const adminId = req.session.user;
  const slipIndex = parseInt(req.params.slipIndex);
