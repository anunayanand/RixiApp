...
exports.assignLecture = asyncHandler(async (req, res) => {
...
exports.toggleLectureVisibility = asyncHandler(async (req, res) => {
  const admin = await Admin.findById(req.session.user);
  if (!admin) return res.status(401).json({ success: false, message: 'Unauthorized' });
...
exports.getLectureToken = asyncHandler(async (req, res) => {
...
exports.playLecture = asyncHandler(async (req, res) => {
