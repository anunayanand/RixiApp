...
async function sendSupportTicketMail(intern, admin, ticketSubject) {
  var subject = `New Support Ticket - ${intern.name}`;
...
An intern has raised a new support ticket.
</p>
</td>
</tr>
</table>
...
This is to notify you that a new support ticket has been raised by <strong>${intern.name}</strong>.
</p>
</td>
</tr>
</table>
...
<p style="margin:0; font-size:13px; font-weight:bold; color:#222;">Ticket Details</p>
<table width="100%" style="margin-top:16px;">
<tr>
<td style="font-size:13px; color:#555; line-height:2;">
<strong>Intern Name:</strong> ${intern.name}<br/>
...
<tr>  
<td align="center">
<a href="${rawUrl}/admin-login" class="button" style="background:#ff6600; color:#ffffff; text-decoration:none; padding:14px 28px; border-radius:12px; font-weight:bold; display:inline-block; font-size:14px;">
